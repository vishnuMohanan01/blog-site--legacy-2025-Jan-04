...
A typical search engine has to go through 3 different phases before it can produce results for our query before us:
...
search engine results as soon as they got hosted somewhere in the internet. For this, we should let search engines know of the site's existence in some address (domain).
